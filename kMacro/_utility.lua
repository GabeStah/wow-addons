...
function kMacro:ColorizeText(text, r, g, b, suppressPrefix)
	return ('%s%s%s'):format(self:RGBToHex(r,g,b,suppressPrefix), text, '|r');
end
...
function kMacro:RGBToHex(r, g, b, suppressPrefix)
