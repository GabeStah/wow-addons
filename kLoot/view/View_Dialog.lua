...
function kLoot:View_Dialog_Create(id, text, width, height, margin, color)
   id = id or 'Default'
   width = width or 300
...
function kLoot:View_DialogButton_Create(id, text, parent, onClick, height, color, hoverColor)
   id = id or 'Button'
   text = text or 'Yes'
   height = height or 30
...
function kLoot:View_DialogTextbox_Create(parent, text, highlightText)
   text = text or ''
