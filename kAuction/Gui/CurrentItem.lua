...
function kAuction:Gui_OnEnterCurrentItemAnchorIcon(frame)
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('anchor')		
...
function kAuction:Gui_OnEnterCurrentItemBestInSlotIcon(frame)
	...
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('bestInSlot',localAuctionData)		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)
end
function kAuction:Gui_OnEnterCurrentItemBidTypeIcon(frame)
	local auction = kAuctionCurrentItemFrame.auction;
	local localAuctionData = kAuction:Client_GetLocalAuctionDataById(auction.id); 
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('bidType',localAuctionData)		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)
end
function kAuction:Gui_OnEnterCurrentItemCloseIcon(frame)
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('close')		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)
end
function kAuction:Gui_OnEnterCurrentItemConfigIcon(frame)
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('config')		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)
end
function kAuction:Gui_OnEnterCurrentItemSetBonusIcon(frame)
	local auction = kAuctionCurrentItemFrame.auction;
	local localAuctionData = kAuction:Client_GetLocalAuctionDataById(auction.id); 
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('setBonus',localAuctionData)		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)
end
function kAuction:Gui_OnEnterCurrentItemCancelIcon(frame)
	local sTitle, sClickText, sText = self:Gui_GetCurrentItemIconStrings('cancel')		
	kAuction:Gui_SetCurrentItemIconTooltipStrings(frame,sTitle,sText,sClickText)	
end
...
function kAuction:Gui_CreateCurrentItemFrame(auction)
	...
	frame.active = true;
	if auctionIcon then 
		local texture = kAuction:Item_GetTextureOfItem(auction.itemLink)
		if texture then	auctionIcon:SetNormalTexture(texture) end
	end
